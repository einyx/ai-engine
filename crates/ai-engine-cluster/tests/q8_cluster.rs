...
//!
//! Spins up a leader + 2 workers loading the toy-llama-3-q8 fixture, runs
//! 5-token greedy generation across the cluster, and asserts the output
//! matches a single-node Q8 baseline exactly. Greedy + lossless wire
