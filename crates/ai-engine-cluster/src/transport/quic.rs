...
/// Build a quinn `ClientConfig` that authenticates servers by SHA-256
/// certificate fingerprint. Shared by `client_endpoint` (star/leader dialer)
/// and the full-mesh transport, where one endpoint both accepts and dials.
...
pub fn client_endpoint(
    ...
    let client_cfg = client_config(identity, trusted_fingerprints)?;
